...
export const toNow = (date: string | Date) => formatDistanceToNow(new Date(date), { addSuffix: true });
export const isAfterDate = (date1: string | Date, date2: string | Date) => isAfter(new Date(date1), new Date(date2));
export const plusDays = (date: string | Date, day: number) => add(new Date(date), { days: day });
