...
//             // const img = document.getElementById(post.node.id).getElementsByTagName('img');
//             return (
//               <div
//                 id={post.node.id}
//                 key={post.node.id}
//                 className="container mt-5 aax"
//               >
...
//                   {getTechTags(tags)}
//                 </small>
//                 {/*<img src={img.length >= 1 ? img[0].src : ""} alt="no"/>*/}
//                 <p id={post.node.id} className="text-center d-inline">
//                   {post.node.excerpt}
//                 </p>
