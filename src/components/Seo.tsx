...
export default function Seo({ title, path = "", description }: SeoAttr) {
  ...
  const metaImage = `${metadata.siteUrl}/ferry-suhandri.jpg`;
  const metaImageLarge = `${metadata.siteUrl}/ferry-suhandri-large.jpg`;
